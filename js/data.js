...
const portfolioProjects = [
  ...
  },
  {
    ...
    coverImage: '',
    images: [],
    documents: [pdfItem(githubLfsMediaPath('assets/images/portfolio/Graduation Project.pdf'), 'Graduation Project')],
  ...
  },
  {
    ...
    coverImage: '',
    images: [],
    documents: [pdfItem(githubLfsMediaPath('assets/images/portfolio/LAKME FASHION WEEK (1).pdf'), 'Lakme Fashion Week')],
  ...
  },
  {
    ...
    coverImage: '',
    images: [],
    documents: [pdfItem(githubLfsMediaPath('assets/images/portfolio/PRINT PORTFOLIO-GRAPHIC.pdf'), 'Print Portfolio Graphic')],
